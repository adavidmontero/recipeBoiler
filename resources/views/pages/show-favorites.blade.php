...
@section('content')
    <div class="album py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h3 class="mb-4">Mis recetas favoritas</h3>
                    @if ($recipes->count() > 0)
                    ...
                    @else
                        <div class="alert bg-green text-white text-center" role="alert">
                            Al parecer aún no cuentas con recetas favoritas, revisa todas las 
                            que tenemos ahora mismo dando click 
                            <a href="/" class="text-white text-uppercase">¡aquí!<a/>
                        </div>
                    @endif
